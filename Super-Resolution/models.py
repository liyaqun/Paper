...
class SRResNet(nn.Module):
    ...
    def __init__(self, large_kernel_size=9, small_kernel_size=3, n_channels=64, n_blocks=8, scaling_factor=4):
        """
...
class Generator(nn.Module):
    ...
    def __init__(self, large_kernel_size=9, small_kernel_size=3, n_channels=64, n_blocks=16, scaling_factor=4):
        ...
        self.net = SRResNet(large_kernel_size=large_kernel_size, small_kernel_size=small_kernel_size,
                            n_channels=n_channels, n_blocks=8, scaling_factor=scaling_factor)
    ...
    def initialize_with_srresnet(self, srresnet_checkpoint):
        ...
        # srresnet = torch.load(srresnet_checkpoint,weights_only=True)['model']
...
class TruncatedVGG19(nn.Module):
    ...
    def __init__(self, i, j):
        ...
        # C:\Users\李亚群/.cache\torch\hub\checkpoints\vgg19-dcbb9e9d.pth

        maxpool_counter = 0  # 统计遇到的maxpool层数
        conv_counter = 0  # 在当前maxpool之后遇到的conv层数
        truncate_at = 0  # 记录截断位置
